...
namespace NUnitTests
{
    class UnitTests
    {
        ...
        public void Returns_Win_For_Rock_And_Scissors()
        {
            ...
            int result = rule.Winner((int)Weapon.Rock,(int)Weapon.Scissors);
        ...
        {
            int result = rule.Winner((int)Weapon.Scissors,(int)Weapon.Paper);
            Assert.AreEqual((int)Outcome.Won, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Paper,(int)Weapon.Rock);
            Assert.AreEqual((int)Outcome.Won, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Scissors,(int)Weapon.Rock);
        ...
        {
            int result = rule.Winner((int)Weapon.Paper,(int)Weapon.Scissors);
            Assert.AreEqual((int)Outcome.Lost, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Rock,(int)Weapon.Paper);
            Assert.AreEqual((int)Outcome.Lost, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Rock, (int)Weapon.Rock);
        ...
        {
            int result = rule.Winner((int)Weapon.Paper, (int)Weapon.Paper);
            Assert.AreEqual((int)Outcome.Draw, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Scissors, (int)Weapon.Scissors);
            Assert.AreEqual((int)Outcome.Draw, result);
        }
        ...
        {
            int result = rule.Winner((int) Weapon.Invalid, (int) Weapon.Invalid);
        ...
        {
            int result = rule.Winner((int) Weapon.Rock, (int) Weapon.Invalid);
            Assert.AreEqual((int)Outcome.Invalid,result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Paper, (int)Weapon.Invalid);
            Assert.AreEqual((int)Outcome.Invalid, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Scissors, (int)Weapon.Invalid);
            Assert.AreEqual((int)Outcome.Invalid, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Invalid, (int)Weapon.Rock);
            Assert.AreEqual((int)Outcome.Invalid, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Invalid, (int)Weapon.Paper);
            Assert.AreEqual((int)Outcome.Invalid, result);
        }
        ...
        {
            int result = rule.Winner((int)Weapon.Invalid, (int)Weapon.Scissors);
            Assert.AreEqual((int)Outcome.Invalid, result);
        }
    }
}
